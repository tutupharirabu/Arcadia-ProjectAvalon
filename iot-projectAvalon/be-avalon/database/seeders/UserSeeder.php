...
class UserSeeder extends Seeder
{
     ...
     *
     * Catatan keamanan: password dibuat acak (16 karakter) sehingga kredensial
     * lemah seperti "password123" tidak pernah dipakai di produksi.
     * Password tiap akun TIDAK diketahui — harus di-reset melalui alur
     * forgot-password setelah proses seeding.
     */
